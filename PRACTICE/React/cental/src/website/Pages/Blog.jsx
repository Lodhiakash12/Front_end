                                    ...
                                    <div className="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                                        <div className="blog-item">
                                            <div className="blog-img">
                                                <img src={data.img} className="img-fluid rounded-top w-100" style={{height:"300px"}} alt="Image" />
                                            </div>
                                            <div className="blog-content rounded-bottom p-4">
                                                ...
                                                <div className="blog-comment my-3">
                                                    ...
                                                    <div className="small"><span className="fa fa-comment-alt text-primary" /><span className="ms-2">{data.comments}</span></div>
                                                </div>
