                    ...
                    <div className="row gx-0 align-items-center" style={{ height: 45 }}>
                        <div className="col-lg-6 text-center text-lg-start mb-lg-0">
                            <div className="d-flex flex-wrap">
                                <NavLink href="#" className="text-muted me-4"><i className="fas fa-map-marker-alt text-primary me-2" />Find A Location</NavLink>
                    ...
                    <nav className="navbar navbar-expand-lg navbar-light">
                        ...
                        <div className="collapse navbar-collapse" id="navbarCollapse">
                            <div className="navbar-nav mx-auto py-0">
                                <NavLink to="/dash" className="nav-item nav-link ">Dash</NavLink>
                                ...
                                <NavLink to="/Service" className="nav-item nav-link">Service</NavLink>
                                 ...
                                 <div className="nav-item dropdown">
                                    ...
                                    <div className="dropdown-menu m-0">
                                        <NavLink to="/blogmanage" className="dropdown-item">Manage Blogs</NavLink>
                                        <NavLink to="/blogadd" className="dropdown-item">Add Blog</NavLink>
