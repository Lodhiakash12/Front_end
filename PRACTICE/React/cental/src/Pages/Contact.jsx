...
import Footer from '../Common/Footer'
 ...
 function Contact() {
   return (
    <div>
        <Header />
          <Navb title="Contact" name="Contact"/>
      ...
      <div className="row g-5">
        ...
        <div className="col-12 col-xl-1 wow fadeInUp" data-wow-delay="0.3s">
          <div className="d-flex flex-xl-column align-items-center justify-content-center">
            <a className="btn btn-xl-square btn-light rounded-circle mb-0 mb-xl-4 me-4 me-xl-0" href><i className="fab fa-facebook-f" /></a>
            <a className="btn btn-xl-square btn-light rounded-circle mb-0 mb-xl-4 me-4 me-xl-0" href><i className="fab fa-twitter" /></a>
            <a className="btn btn-xl-square btn-light rounded-circle mb-0 mb-xl-4 me-4 me-xl-0" href><i className="fab fa-instagram" /></a>
            <a className="btn btn-xl-square btn-light rounded-circle mb-0 mb-xl-0 me-0 me-xl-0" href><i className="fab fa-linkedin-in" /></a>
          </div>
        </div>
          ...
          <div className="p-5 bg-light rounded">
            <div className="bg-white rounded p-4 mb-4">
              ...
              <div className="d-flex align-items-center flex-shrink-0 mb-3">
                <p className="mb-0 text-dark me-2">Address:</p><i className="fas fa-map-marker-alt text-primary me-2" /><p className="mb-0">123 Street New York.USA</p>
              </div>
              <div className="d-flex align-items-center">
                <p className="mb-0 text-dark me-2">Telephone:</p><i className="fa fa-phone-alt text-primary me-2" /><p className="mb-0">(+012) 3456 7890</p>
              </div>
            </div>
            <div className="bg-white rounded p-4 mb-4">
